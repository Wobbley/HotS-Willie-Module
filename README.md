...
* Get the parameters file and then edit it to set the correct path to the database file:  `curl -sSL https://raw.githubusercontent.com/Wobbley/HotS-Willie-Module/master/parameters.yml.dist -o parameters.yml; vim parameters.yml`
* Run willie: `willie`
...
* Test by running willie:
  * `cp parameters.yml.dist parameters.yml` and edit the path to the database file 
